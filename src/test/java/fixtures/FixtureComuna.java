...
public class FixtureComuna {
	...
	public static Point damePosicionFronteraComunaValida() {
		return new Point(-34.611015, -58.529025);
	}

	public static Point damePosicionIncluidaOtraComunaValida() {
		return new Point(-34.6229418, -58.4146764);
	}

	public static Point damePosicionNoIncluidaOtraComunaValida() {
		return new Point(-34.6327475, -58.4851585);
	}
